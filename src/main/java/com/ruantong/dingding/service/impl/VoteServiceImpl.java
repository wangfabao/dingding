package com.ruantong.dingding.service.impl;
...
import com.ruantong.dingding.config.DingTalkUtils;
import com.ruantong.dingding.config.UuidUtil;
import com.ruantong.dingding.mapper.UserVotingMapper;
import com.ruantong.dingding.mapper.CreateVoteMapper;
import com.ruantong.dingding.VO.CreateVoteVO;
import com.ruantong.dingding.pojo.UserVoting;
import com.ruantong.dingding.service.VoteService;
...
//        用户投票结束后查询结果
        ...
        for (UserVotingDTO userVotingDTO : userVotingDTOS) {
